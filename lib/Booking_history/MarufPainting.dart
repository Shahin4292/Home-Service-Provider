...
class Maruf extends StatefulWidget {
  const Maruf({super.key});

  @override
  State<Maruf> createState() => _MarufState();
}



class _MarufState extends State<Maruf> {


  Widget buildMarufFrom() {
              ...
              const Row(
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      SizedBox(height: 20,),
                      Text("Maruf", style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold, color: Colors.white),),
                      Text("I have been specializing in", style: TextStyle(fontSize: 20,color: Colors.white),),
                      Text("Painting for 4 years", style: TextStyle(fontSize: 20,color: Colors.white),),
                    ],
                  )
                ],
              ),
