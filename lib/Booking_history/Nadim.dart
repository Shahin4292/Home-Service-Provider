...
class Nadim extends StatefulWidget {
  const Nadim({super.key});

  @override
  State<Nadim> createState() => _NadimState();
}



class _NadimState extends State<Nadim> {


  Widget buildNadimFrom() {
              ...
              const Row(
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      SizedBox(height: 20,),
                      Text("Nadim", style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold, color: Colors.white),),
                      Text("I have been specializing in", style: TextStyle(fontSize: 20,color: Colors.white),),
                      Text("Electrician for 5 years", style: TextStyle(fontSize: 20,color: Colors.white),),
                    ],
                  )
                ],
              ),
