              ...
              Column(
                ...
                children: [
                  Container(
                    ...
                    height: 90,
                    child: Image.asset('assets/images/Asim.jpg'),
                  ),
                ],
              ),
              ...
              const Row(
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      SizedBox(height: 20,),
                      Text("Arif", style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold, color: Colors.white),),
                      Text("I have been specializing in", style: TextStyle(fontSize: 20,color: Colors.white),),
                      Text("dry cleaning for 3 years", style: TextStyle(fontSize: 20,color: Colors.white),),
                    ],
                  )
                ],
              ),
